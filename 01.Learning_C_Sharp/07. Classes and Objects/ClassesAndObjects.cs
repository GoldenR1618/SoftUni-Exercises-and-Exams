namespace Classes_and_Objects
{
    ...
    public class ClassesAndObjects
    {
        public static void Main(string[] args)
        {
            ...
            //public class Animal { public virtual void Eat() { … } }       - указваме, че този метод МОЖЕ да бъде оувъррайднат.
            //public class Dog : Animal { public override void Eat() { } }  - оувъррайдваме Eat метода.
    ...
    public class Cat : Animal   //Cat наследява клас Animal
    {
        ...
        {                       //а направо продължаваме да описваме само логиката за "age". С :base можем да викнем базовият конструктор от бащиният клас.
            this.Age = age;
        }
