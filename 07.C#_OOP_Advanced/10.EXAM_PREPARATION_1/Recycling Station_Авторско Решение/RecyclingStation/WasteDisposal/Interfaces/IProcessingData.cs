namespace RecyclingStation.WasteDisposal.Interfaces
{
    ...
    public interface IProcessingData
    {
        ...
        /// <summary>
        /// The resulting profit/loss in capital (money) from processing the garbage, if the number is negative it means the process costed more, than the ammount of profits it provided. 
        /// </summary>
