namespace RecyclingStation.WasteDisposal.Interfaces
{
    ...
    /// <summary>
    /// Interface that Garbage Processors have to implement.
    /// </summary>
    public interface IStrategyHolder
    {
        /// <summary>
        /// Returns a enumerable of type IGarbageDisposalStrategy with the currently contained strategies in the Garbage Processor.
        /// </summary>
